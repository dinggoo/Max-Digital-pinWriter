...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 548.0, 15.0, 332.0, 47.0 ],
					"text" : "ARDUINO CODE"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 281.0, 56.0, 67.0, 20.0 ],
					"text" : "Value"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 198.0, 56.0, 67.0, 20.0 ],
					"text" : "pinNo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 74.0, 277.0, 33.0, 22.0 ],
					"text" : "== 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 74.0, 314.0, 105.671875, 25.40625 ],
					"presentation" : 1,
					"presentation_rect" : [ 488.348737199689594, 51.342239379882812, 150.671875, 21.40625 ],
					"spacing_x" : 19.0,
					"text" : "OFF",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 278.0, 85.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 198.0, 85.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 198.0, 121.0, 99.0, 22.0 ],
					"text" : "pak i i"
				}
...
,
					"patching_rect" : [ 198.0, 239.0, 97.0, 22.0 ],
...
, 			{
				"box" : 				{
					"id" : "obj-4",
					"items" : [ "open", ",", "print", ",", "close", ",", "reset" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 74.0, 239.0, 100.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 198.0, 277.0, 153.0, 22.0 ],
